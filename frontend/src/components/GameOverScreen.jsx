...
export default function GameOverScreen({ winner, replay }) {
  return (
    <div className="h-screen w-full bg-gray-800 to-black flex flex-col items-center justify-center p-6 font-mono text-center ">
        ...
        <div className={`mb-8 w-3/4 h-full flex flex-col justify-between rounded-2xl pb-6 px-4 shadow-inner ${winner[0] === 'spy' ? 'bg-red-500' : 'bg-blue-500'}`}>
          ...
          <p className='m-2 rounded-full bg-white text-2xl text-black'>spy was <span className='font-bold'>{winner[2]}</span></p>
